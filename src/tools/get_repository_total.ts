...
const CreateClientParamsWithLang = CreateClientParams.extend({
	lang: z.string().optional().describe("The locale (lang) to filter by"),
})

export const get_repository_total = tool(
...
export const get_repository_total_by_type = tool(
	...
	CreateClientParamsWithLang.extend({
		type: z.string().min(1).describe("The type to filter by"),
	}).shape,
	async (args) => {
		const client = createCachedClient(args)
...
export const get_repository_total_by_tag = tool(
...
export const get_repository_total_by_every_tag = tool(
...
export const get_repository_total_by_some_tags = tool(
