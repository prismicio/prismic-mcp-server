...
2. **Follow project patterns**
   ...
   - Code: Analyze codebase for consistent patterns and conventions. If you see a bare slice component, replace the existing code with the one you will generate.
