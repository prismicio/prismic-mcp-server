...
- If you were vaguely instructed with something like "Create a <name> slice", it's strongly recommended that, besides generating the slice model, you also code its component and generate its mock data, so that the slice is fully functional. If you have more detailed instructions on how to operate, you can ignore this recommendation.`
